...
{
    /// <summary>
    /// Gravimetric strength generated by asteroid
    /// </summary>
    [SerializeField]
    private float GravimetricStrength = 1f;
    ...
    private void Move()
    {
        ...
        transform.position = transform.position + distance * 0.1f * Time.deltaTime;
    }
